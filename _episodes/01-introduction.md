...
> To change the prompt to a dollar sign (followed by a space), enter the command:
> `PS1='$ '`
> Your window should look like our example in this lesson.  
> To change back to your original prompt, type in the output of the previous echo command (this will be different depending on the
> original configuration) between the quotes in the command:
> PS1=""
> For example, if the output of `echo $PS1` was `\u@\h:\w $ `, then type those characters between the quotes in the above command.
> Alternatively, you can reset your original prompt by logging off and logging back in.
